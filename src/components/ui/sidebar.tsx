...
>(({ className, showIcon = false, ...props }, ref) => {
  // Random width between 50 to 90%. useState's lazy initializer (unlike useMemo) is
  // guaranteed to run exactly once per mount, which is what a stable random value needs.
